...
public class ScheduledPaymentPage_Demo {
	...
	def selectPaymentMethod(paymentMethod) {
		...
		WebUI.selectOptionByLabel(findTestObject('Object Repository/ABP/Page_SchedulePayment/select_PaymentMethod_Demo'), paymentMethod, false)
	}
