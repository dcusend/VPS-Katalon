...
public class PendingBillPage_Demo {
	...
	def setDataCardInfo(String CardIDS) {
		...
		if ((!cardNumber.isEmpty())) {
			WebUI.setText(findTestObject('Object Repository/ABP/BillsLabelPage/PaymentEntryCC/input_cardAccountNumber_Demo'),cardNumber)
		}


		if ((!cvv.isEmpty())) {
			WebUI.setText(findTestObject('Object Repository/ABP/BillsLabelPage/PaymentEntryCC/input_cvv_Demo'),cvv)
		}
	...
	def setPersonalACHData(String ACHIDS) {
		...
		if ((!accountNumber.isEmpty())) {
			WebUI.setText(findTestObject('Object Repository/ABP/BillsLabelPage/PaymentEntryACHPersonal/input_AccountNumber_Demo'),accountNumber)
		}

		if ((!confirmAccountNumber.isEmpty())) {
			WebUI.setText(findTestObject('Object Repository/ABP/BillsLabelPage/PaymentEntryACHPersonal/input_ConfirmAccountNumber_Demo'),confirmAccountNumber)
		}
	}
