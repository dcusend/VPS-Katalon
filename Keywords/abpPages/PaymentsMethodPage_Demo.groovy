...
public class PaymentsMethodPage_Demo {
	...
	def selectPaymentMethodCC() {
		WebUI.selectOptionByLabel(findTestObject('Object Repository/ABP/Page_Payment Method/select_SelectPaymentType_Demo'), "Credit Card", false)
	}

	@Keyword
	def selectPaymentMethodPersonalSaving() {
		WebUI.selectOptionByLabel(findTestObject('Object Repository/ABP/Page_Payment Method/select_SelectPaymentType_Demo'), "Personal Savings", false)
	}

	@Keyword
	def selectPaymentMethodPersonalChecking() {
		WebUI.selectOptionByLabel(findTestObject('Object Repository/ABP/Page_Payment Method/select_SelectPaymentType_Demo'), "Personal Checking", false)
	}

	@Keyword
	def selectPaymentMethodBusinessChecking() {
		WebUI.selectOptionByLabel(findTestObject('Object Repository/ABP/Page_Payment Method/select_SelectPaymentType_Demo'), "Business Checking", false)
	}
	...
	def setDataCardInfo(String CardIDS) {
		...
		if ((!cardNumber.isEmpty())) {
			WebUI.setText(findTestObject('Object Repository/ABP/Page_Payment Method/input_cardNumber_demo'),cardNumber)
		}
	...
	def setPersonalACHData(String ACHIDS) {
		...
		if ((!accountNumber.isEmpty())) {
			WebUI.setText(findTestObject('Object Repository/ABP/Page_Payment Method/input_AccountNumber_Demo'),accountNumber)
		}
