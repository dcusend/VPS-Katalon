...
def numOfRows, dataFile, nameSheet
	...
	nameSheet = "Sale-Credit-Void"
	numOfRows = findTestData('QA/VLinkTestData/VLinkSaleCreditVoidData').getRowNumbers()
	println("Number of Records: " + numOfRows)
	dataFile = "QA/VLinkTestData/VLinkSaleCreditVoidData"
