...
def numOfRows, dataFile, nameSheet
	...
	nameSheet = "DebitCredit-RemID-Pipe"
	numOfRows = findTestData('QA/VLinkTestData/VLinkDebitCreditRemIDPipeData').getRowNumbers()
	println("Number of Records: " + numOfRows)
	dataFile = "QA/VLinkTestData/VLinkDebitCreditRemIDPipeData"
				...
				if (WebUI.verifyTextPresent(("Transaction approved, no errors"), true))
					{
						...
						WebUI.setText(findTestObject('Object Repository/RecAndPlayBk/Page-Vlink-ACH-Credit/input_Remittance Id'), GlobalVariable.VLinkSaleRemID)
						...
						WebUI.setText(findTestObject('Object Repository/RecAndPlayBk/Page-Vlink-ACH-Credit/input_Transaction ID'), GlobalVariable.VLinkSaleTranxID)
