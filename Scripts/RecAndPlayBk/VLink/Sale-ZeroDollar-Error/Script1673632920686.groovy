...
def numOfRows, dataFile, nameSheet
	...
	nameSheet = "Sale-ZeroDollar"
	numOfRows = findTestData('QA/VLinkTestData/VLinkSaleZeroDollar').getRowNumbers()
	println("Number of Records: " + numOfRows)
	dataFile = "QA/VLinkTestData/VLinkSaleZeroDollar"
			...
			if (ExecuteTC.equalsIgnoreCase("Y"))
				{
					...
					if (WebUI.verifyTextPresent(("invalid: amount"), true))
						{
							println "Parameter value(s) invalid: amount text is present on the Confirmation page"
						...
						{
							println "Parameter value(s) invalid: amount text is not present on the Confirmation page"
