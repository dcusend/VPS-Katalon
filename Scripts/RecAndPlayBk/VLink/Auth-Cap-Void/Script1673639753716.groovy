...
def numOfRows, dataFile, nameSheet
	...
	nameSheet = "Auth-Cap-Void"
	numOfRows = findTestData('QA/VLinkTestData/VLinkAuthCapVoidData').getRowNumbers()
	println("Number of Records: " + numOfRows)
	dataFile = "QA/VLinkTestData/VLinkAuthCapVoidData"
										...
										if (WebUI.verifyTextPresent(("Transaction approved, no errors"), true))
											{
												...
												WebUI.setText(findTestObject('Object Repository/RecAndPlayBk/Page-Vlink-CC-Void/txt_TransactionID'), GlobalVariable.VLinkSaleTranxID)
												
												WebUI.setText(findTestObject('Object Repository/RecAndPlayBk/Page-Vlink-CC-Void/txt_OriginalTransactionType'), '102')
											...
											{
												println "Capture was not successful, Don't Void"
												System.out.println('Fail Record Number: ' + row)
												resText = "Fail"
												CustomKeywords.'pages.WriteExcel.demoKey'(resText,datText,resColumn,datCloumn,fileLoc,nameSheet,row)
