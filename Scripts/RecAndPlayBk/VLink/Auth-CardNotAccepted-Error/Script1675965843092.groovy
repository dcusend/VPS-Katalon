...
def numOfRows, dataFile, nameSheet
	...
	nameSheet = "Auth-CardNotAccepted"
	numOfRows = findTestData('QA/VLinkTestData/VLinkAuthCardNotAcceptedData').getRowNumbers()
	println("Number of Records: " + numOfRows)
	dataFile = "QA/VLinkTestData/VLinkAuthCardNotAcceptedData"
			...
			if (ExecuteTC.equalsIgnoreCase("Y"))
				{
					...
					if (WebUI.verifyTextPresent(("Card type not valid"), true))
						{
							println "Card type not valid text is present on the Confirmation page"
						...
						{
							println "Card type not valid text is not present on the Confirmation page"
