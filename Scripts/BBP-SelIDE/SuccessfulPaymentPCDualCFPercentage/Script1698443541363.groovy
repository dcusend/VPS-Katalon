...
//softAssertion.assertEquals(Pattern.matches('selenium.getText("//tr[18]/td[2]")', "Personal.*"), true)
//softAssertion.assertEquals(Pattern.matches('selenium.getText("//tr[18]/td[2]")', "Checking.*"), true)
