...
WebUI.setText(to("name=amount"), ("60.00").toString())
...
//softAssertion.assertEquals("One transaction in the amount of $66.00 will appear on your bank statement.", selenium.getText("//td/p[2]"))
...
WebUI.verifyTextPresent(("One transaction in the amount of \$66.00 will appear on your bank statement."), false)
...
WebUI.waitForPageLoad(pageLoadTimeoutSeconds)
WebUI.delay(15)
//softAssertion.assertEquals("$60.00", selenium.getText("//tr[7]/td[2]"))
//softAssertion.assertEquals("$6.00", selenium.getText("//tr[8]/td[2]"))
//softAssertion.assertEquals("Single Transaction", selenium.getText("//tr[9]/td[2]"))
//softAssertion.assertEquals("$66.00", selenium.getText("//tr[10]/td[2]"))
//softAssertion.assertEquals("Debit", selenium.getText("//tr[11]/td[2]"))
//softAssertion.assertEquals(Pattern.matches('selenium.getText("//tr[12]/td[2]")', "Personal.*"), true)
//softAssertion.assertEquals(Pattern.matches('selenium.getText("//tr[12]/td[2]")', "Checking.*"), true)
