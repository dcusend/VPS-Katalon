...
selenium.type("name=userDefined1", ("UDF1 Data2").toString())
...
//softAssertion.assertEquals("UDF2 Data2", selenium.getText("//tr[5]/td[2]"))
//softAssertion.assertEquals("UDF3 Data2", selenium.getText("//tr[6]/td[2]"))
//softAssertion.assertEquals("UDF6 Data2", selenium.getText("//tr[9]/td[2]"))
//softAssertion.assertEquals("UDF7 Data2", selenium.getText("//tr[10]/td[2]"))
//softAssertion.assertEquals("UDF8 Data2", selenium.getText("//tr[11]/td[2]"))
...
WebUI.verifyTextPresent(("UDF1 Data2"), true)
