...
selenium.type("id=field1", "444150")
selenium.type("id=field2", "444151")
...
softAssertion.assertEquals("", selenium.getText("name=userDefined3"))
softAssertion.assertEquals("--Select One--OrangePurple", selenium.getText("name=variableField4DropdownGroupItemID"))
softAssertion.assertEquals("--Select One--OrangePurple", selenium.getText("name=variableField5DropdownGroupItemID"))
softAssertion.assertEquals("", selenium.getText("name=userDefined6"))
softAssertion.assertEquals("", selenium.getText("name=userDefined7"))
softAssertion.assertEquals("", selenium.getText("name=userDefined8"))
selenium.type("name=userDefined1", ("UDF1 Data1").toString())
...
//softAssertion.assertEquals("UDF2 Data1", selenium.getText("//tr[5]/td[2]"))
//softAssertion.assertEquals("UDF3 Data1", selenium.getText("//tr[6]/td[2]"))
//softAssertion.assertEquals("Purple", selenium.getText("//tr[7]/td[2]"))
//softAssertion.assertEquals("Orange", selenium.getText("//tr[8]/td[2]"))
//softAssertion.assertEquals("UDF6 Data1", selenium.getText("//tr[9]/td[2]"))
//softAssertion.assertEquals("UDF7 Data1", selenium.getText("//tr[10]/td[2]"))
//softAssertion.assertEquals("UDF8 Data1", selenium.getText("//tr[11]/td[2]"))
...
WebUI.verifyTextPresent(("UDF1 Data1"), true)
