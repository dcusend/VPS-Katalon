...
WebUI.verifyMatch(WebUI.getText(to("name=variableField4DropdownGroupItemID")), "--Select One--OrangePurple", false)
WebUI.verifyMatch(WebUI.getText(to("name=variableField5DropdownGroupItemID")), "--Select One--OrangePurple", false)
...
WebUI.setText(to("name=userDefined1"), ("UDF1 Data1").toString())
