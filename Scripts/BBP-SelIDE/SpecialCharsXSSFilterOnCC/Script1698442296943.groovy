...
selenium.type("name=userDefined6", ("%").toString())
selenium.type("name=userDefined7", ("=").toString())
selenium.type("name=userDefined8", ("?").toString())
selenium.type("name=billingName", ("Hunter Cañon").toString())
