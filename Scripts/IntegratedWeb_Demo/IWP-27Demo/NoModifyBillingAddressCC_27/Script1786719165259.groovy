...
String fileLoc = "KatalonData/IWPBootstrapDataDemo/VRelayPaymentsCC_27.xlsx"
...
String path = fileLoc
nameSheet = "NoModifyBillingAddressCC"
	...
	if (ExecuteTC.equalsIgnoreCase("Y"))
		{
			...
			// Select Make a Payment Button
				...
				if(WebUI.verifyElementAttributeValue(findTestObject('Object Repository/IWP_Bootstrap/Page_PaymentEntryCC_Bootstrap/input_billingAddress'), "readonly", 'true', 20) && WebUI.verifyElementAttributeValue(findTestObject('Object Repository/IWP_Bootstrap/Page_PaymentEntryCC_Bootstrap/input_billingAddress2'), "readonly", 'true', 20))
					{
