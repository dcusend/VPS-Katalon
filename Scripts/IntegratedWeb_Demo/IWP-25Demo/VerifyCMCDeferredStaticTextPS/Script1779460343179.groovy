...
String fileLoc = "KatalonData/IWPBootstrapDataDemo/VRelayPaymentsACH_25.xlsx"
			...
			if (WebUI.verifyTextPresent("Deferred", false))
				{
					...
					if (WebUI.verifyTextPresent("View Scheduled Payments", false)) {
							WebUI.click(findTestObject('Object Repository/IWP_Bootstrap/Page_ScheduledPayments_Bootstrap/a_Edit'))									
								...
								WebUI.verifyElementPresent(findTestObject('Object Repository/IWP_Bootstrap/Page_EditPaymentPlan_Deferred/firstname_check'), 10)
								
								WebUI.verifyTextPresent(('Last Name on Check'), false)
								
								WebUI.verifyElementPresent(findTestObject('Object Repository/IWP_Bootstrap/Page_EditPaymentPlan_Deferred/lastname_check'), 10)
								...
								WebUI.verifyElementPresent(findTestObject('Object Repository/IWP_Bootstrap/Page_EditPaymentPlan_Deferred/account_type_pc'), 10)
...
//										WebUI.verifyTextPresent(('Payment Information'),false)
								...
								WebUI.verifyTextPresent(('Personal Saving'),false)
			...
			//				WebUI.verifyTextPresent(('dh8RqB9LubsT'),false)
