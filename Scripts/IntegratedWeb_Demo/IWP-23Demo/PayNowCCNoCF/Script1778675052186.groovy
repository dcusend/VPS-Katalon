...
String fileLoc = "KatalonData/IWPBootstrapDataDemo/VRelayPaymentsCC_23.xlsx"
	...
	if (ExecuteTC.equalsIgnoreCase("Y"))
		{
			...
			// Select Confirm Button on Payment Confirmation Page
				...
				WebUI.verifyTextPresent(("JASMINE PATRINOL"), false)
				
				WebUI.verifyTextPresent(("Card Type"), false)
				
				WebUI.verifyTextPresent(("Card Number"), false)
												
				WebUI.verifyTextPresent(('************0035'),false)
				...
				WebUI.verifyTextPresent(('10/2028'),false)
				...
				WebUI.verifyTextPresent(('VA'),false)
