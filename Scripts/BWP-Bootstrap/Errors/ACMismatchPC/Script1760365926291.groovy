	...
	for (def row = 1; row <= numOfRows; row++)
		{
			...
			System.out.println('Begin Record Number: ' + row)
				...
				// setData for PC Payment Entry Page
					...
					if (WebUI.verifyTextPresent("The Account Number Information provided does not match. Please re-enter and confirm your Account Number information.", false))
						{
							println "Mismatch Error message shown"
						...
						{
							println "Mismatch Error message not shown"
