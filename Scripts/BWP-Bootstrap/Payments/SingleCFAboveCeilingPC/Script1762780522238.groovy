		...
		if (ExecuteTC.equalsIgnoreCase("Y"))
			{
				...
				// setData for CC Payment Entry Page
					...
					if (WebUI.verifyTextPresent(("80.00"), false))
						{
							println "80.00 text is present on the Receipt page"
						...
						{
							println "80.00 text is not present on the Receipt page"
