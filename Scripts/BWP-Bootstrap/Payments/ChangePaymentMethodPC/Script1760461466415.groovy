...
for (def row = 1; row <= numOfRows; row++)
	{
		...
		if (ExecuteTC.equalsIgnoreCase("Y"))
			...
			// select Change Payment Button
					...
					WebUI.verifyElementPresent(findTestObject('Object Repository/BWP_Bootstrap/Page_SelectPaymentMethod/PayByCorporateCheck'), 30)
					WebUI.verifyElementPresent(findTestObject('Object Repository/BWP_Bootstrap/Page_SelectPaymentMethod/PayByCreditCard'), 30)
					WebUI.verifyElementPresent(findTestObject('Object Repository/BWP_Bootstrap/Page_SelectPaymentMethod/PayByPersonalCheck'), 30)
					WebUI.verifyElementPresent(findTestObject('Object Repository/BWP_Bootstrap/Page_SelectPaymentMethod/MakePaymentButton'), 30)
