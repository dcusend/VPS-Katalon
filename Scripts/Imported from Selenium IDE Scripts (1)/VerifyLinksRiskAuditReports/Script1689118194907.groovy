...
'Generated date: 11-Jul-2023 07:29:54 PM'
...
"verifyText | css=code | View security and permissions details (e.g. role creation/deletion, user assignment, permissions assignment) for a role, over a given time period. | "
verifyEquals("View security and permissions details (e.g. role creation/deletion, user assignment, permissions assignment) for a role, over a given time period.", selenium.getText("css=code"))

"verifyElementPresent | link=User Actions Report |  | "
verifyTrue(selenium.isElementPresent("link=User Actions Report"))

"verifyText | css=#Audit_Reports2 > code | View details of all actions performed within the User Management module by a user, over a given time period. | "
verifyEquals("View details of all actions performed within the User Management module by a user, over a given time period.", selenium.getText("css=#Audit_Reports2 > code"))

"verifyElementPresent | link=User History Report |  | "
verifyTrue(selenium.isElementPresent("link=User History Report"))

"verifyText | css=#Audit_Reports3 > code | View security and permissions details (e.g. account creation/deletion, password resets, role assignment) for a user, over a given time period. | "
verifyEquals("View security and permissions details (e.g. account creation/deletion, password resets, role assignment) for a user, over a given time period.", selenium.getText("css=#Audit_Reports3 > code"))
