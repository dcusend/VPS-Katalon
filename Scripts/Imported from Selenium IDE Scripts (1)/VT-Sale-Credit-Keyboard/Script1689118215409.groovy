...
'Generated date: 11-Jul-2023 07:30:15 PM'
...
"verifyText | id=maincontent-2col | regexp:Transaction Type: Authorization and Capture.* | "
verifyTrue(selenium.getText("id=maincontent-2col").matches("regexp:Transaction Type: Authorization and Capture..*"))
...
"addSelection | name=ccTransactionTypes | label=Authorization & Capture (Sale) | "
selenium.addSelection("name=ccTransactionTypes", "label=Authorization & Capture (Sale)")
...
"click | link=Credit this transaction |  | "
selenium.click("link=Credit this transaction")

"click | name=submit |  | "
selenium.click("name=submit")

"verifyText | id=maincontent-2col | regexp:Transaction Type: Credit.* | "
verifyTrue(selenium.getText("id=maincontent-2col").matches("regexp:Transaction Type: Credit..*"))
