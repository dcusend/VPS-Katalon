...
selenium.type("name=card_name", ("Jim Corbett").toString())
...
println(tranID)
selenium.open("https://dev-algorithm.govolution.com/vlinktest/QA/version_2_0/CC_credit.html")
selenium.type("name=transaction_type", "103")
selenium.type("name=message_version", ("2.0C").toString())
selenium.type("name=remittance_id", (ran1 + "|" + ran2 + "|" + ran3).toString())
selenium.type("name=application_id", "234")
selenium.type("name=username", "username")
...
println(resTextVoid)
String tranIDVoid = selenium.getEval(" var ran1 = \"" + ran1 + "\";var ran2 = \"" + ran2 + "\";var ran3 = \"" + ran3 + "\";var resText = \"" + resText + "\";var tranID = \"" + tranID + "\";var resTextVoid = \"" + resTextVoid + "\";var storedVars = { 'ran1': ran1,'ran2': ran2,'ran3': ran3,'resText': resText,'tranID': tranID,'resTextVoid': resTextVoid }; " + "storedVars['resTextVoid'].substring(19,28).trim()")
println(tranIDVoid)
