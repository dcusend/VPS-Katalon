 ...
 */
 ...
 selenium.open("https://dev-algorithm.govolution.com/vlinktest/QA/version_2_0/auth.html")
 selenium.type("name=transaction_type", "100")
 ...
 selenium.type("name=card_name", ("Michael Slater").toString())
 selenium.type("name=card_address", ("2000 14th street").toString())
 ...
 selenium.type("name=card_on_file_indicator", "")
 selenium.type("name=stored_credential_indicator", "")
 selenium.type("name=cof_scheduled_indicator", "")
 selenium.type("name=cof_transaction_init_indicator", "")
 ...
 String tranID = resText.substring(35,44).trim()
 
 println(tranID)
 selenium.open("https://dev-algorithm.govolution.com/vlinktest/QA/version_2_0/capture.html")
 selenium.type("name=transaction_type", "102")
 selenium.type("name=message_version", ("2.0C").toString())
 selenium.type("name=remittance_id", (ran1 + "|" + ran2 + "|" + ran3).toString())
 selenium.type("name=application_id", "234")
 selenium.type("name=username", "username")
 selenium.type("name=password", "password")
 selenium.type("name=response_format", "fixed_width")
 selenium.type("name=transaction_id", tranID)
 //WebUI.setText(findTestObject('Object Repository/RecAndPlayBk/Page-VLink-Capture/input_Transaction ID_transaction_id'), tranID)
 selenium.type("name=amount", ("7.50").toString())
 selenium.type("name=order_number", "")
 selenium.type("name=tax_amount", "")
 selenium.type("name=charge_description", "")
 ...
 selenium.click("css=input[type=\"submit\"]")
 selenium.waitForPageToLoad("30000")
 //softAssertion.assertEquals(selenium.isTextPresent("Transaction approved, no errors2"), true)
 WebUI.verifyTextPresent(("Transaction approved, no errors"), true)
 String resTextCap = selenium.getText("css=pre")
 println(resTextCap)
 String tranIDCap = selenium.getEval(" var ran1 = \"" + ran1 + "\";var ran2 = \"" + ran2 + "\";var ran3 = \"" + ran3 + "\";var resText = \"" + resText + "\";var tranID = \"" + tranID + "\";var resTextCap = \"" + resTextCap + "\";var storedVars = { 'ran1': ran1,'ran2': ran2,'ran3': ran3,'resText': resText,'tranID': tranID,'resTextCap': resTextCap }; " + "storedVars['resTextCap'].substring(19,28).trim()")
 println(tranIDCap)
