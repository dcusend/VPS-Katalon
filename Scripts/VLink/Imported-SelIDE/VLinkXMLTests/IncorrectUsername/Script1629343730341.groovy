...
selenium.open("https://dev-algorithm.govolution.com/vlinktest/QA/version_2_0authcap.html")
...
selenium.type("name=username", "hello")
selenium.type("name=password", "testing")
...
selenium.type("name=card_exyr", "2020")
