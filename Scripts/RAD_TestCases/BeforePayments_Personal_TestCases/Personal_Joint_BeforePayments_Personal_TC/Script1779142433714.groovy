...
String fileLoc = "KatalonData/RADTestData/BeforePaymentsPersonal.xlsx"
String nameSheet = "Personal_JNT"
String dataFile = "RADTestData/BeforePaymentsPersonal_Personal_JNT"
...
// Select Pay by Personal Check
			...
			if (WebUI.verifyElementPresent(findTestObject('Object Repository/RAD_Pages/SelectPaymentMethod/PayByPersonalCheck'), 30))
				{
					...
					WebUI.click(findTestObject('Object Repository/RAD_Pages/SelectPaymentMethod/PayByPersonalCheck'))
	...
	// On the VRelay page, confirm fields are prepopulated
					...
					if (WebUI.verifyElementPresent(findTestObject('Object Repository/RAD_Pages/PaymentEntryPersonal_Page/FirstName_Check'), 30))
					...
					def first_Name = WebUI.getAttribute(findTestObject('Object Repository/RAD_Pages/PaymentEntryPersonal_Page/FirstName_Check'), 'value')
					WebUI.verifyMatch("Jimmy", first_Name, false)
					
					def last_Name = WebUI.getAttribute(findTestObject('Object Repository/RAD_Pages/PaymentEntryPersonal_Page/LastName_Check'), 'value')
					...
					{
						case "QAProfile":
								 WebUI.verifyMatch("Anderson", last_Name, false)
						...
						case "DemoProfile":
								WebUI.verifyMatch("btes", last_Name, false)
					
							break
							
						case "Production":
								WebUI.verifyMatch("Davi", last_Name, false)
