...
String cfVerbiageQA = "Payments processed with a credit card through this application incurs an electronic government 2.45% service/convenience fee, with a \$1.00 minimum. Accepted credit cards include Visa, Mastercard, and Discover.\n\nPayments processed with an electronic check [eCheck] will not be assessed a service/convenience fee.\n\nAny fee is assessed by Govolution, LLC and will post as a separate transaction."
String cfVerbiageDemo = "Payments processed with a credit card through this application incurs an electronic government 2.45% service/convenience fee, with a \$1.00 minimum. Accepted credit cards include Visa, Mastercard, and Discover.\n\nPayments processed with an electronic check [eCheck] will not be assessed a service/convenience fee.\n\nAny fee is assessed by Govolution, LLC and will post as a separate transaction."
...
String cfVerbiageProd = "Payments processed with a credit card through this application incurs an electronic government 2.45% service/convenience fee, with a \$1.00 minimum. Accepted credit cards include Visa, Mastercard, and Discover.\n\nPayments processed with an electronic check [eCheck] will not be assessed a service/convenience fee.\n\nAny fee is assessed by Govolution, LLC and will post as a separate transaction."
