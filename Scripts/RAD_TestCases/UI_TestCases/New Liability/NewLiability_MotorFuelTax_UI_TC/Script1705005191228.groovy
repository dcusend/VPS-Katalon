...
// Select Fiduciary Tax from the Payment Type dropwown
		...
		WebUI.selectOptionByLabel(findTestObject('Object Repository/RAD_Pages/Landing_Page/select_NewTaxReturnAmountDue_TaxType'),'Motor Fuel Tax',false)
...
// Verify that Motor Fuel License Number is visible
		WebUI.verifyElementVisible(findTestObject(orPath_TaxInfo + '/input_MotorFuelLicNum'))
