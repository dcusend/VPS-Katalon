...
// Select Tax type from the Tax type dropwown
		WebUI.selectOptionByLabel(findTestObject('Object Repository/RAD_Pages/Landing_Page/select_NewTaxReturnAmountDue_TaxType'),'PTE Composite',false)
...
// Verify FEIN/SSN under Tax Information section
