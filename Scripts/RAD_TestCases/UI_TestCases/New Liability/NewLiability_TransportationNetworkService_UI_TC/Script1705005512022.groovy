...
// Select Fiduciary Tax from the Payment Type dropwown
		...
		WebUI.selectOptionByLabel(findTestObject('Object Repository/RAD_Pages/Landing_Page/select_NewTaxReturnAmountDue_TaxType'),'Transportation Network Services',false)
