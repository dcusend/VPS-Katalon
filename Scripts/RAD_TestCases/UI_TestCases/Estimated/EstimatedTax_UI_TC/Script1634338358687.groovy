 ...
 */
	...
	if (WebUI.verifyElementPresent(findTestObject(orPath_TaxTypeFilingYear + '/select_PaymentType'), 30))
		{
			System.out.println('Payment Type drop down was found on the Estimated Tax Page')
		}
	else
		{
			System.out.println('Payment Type drop down was NOT found on the Estimated Tax Page')
		}
	
		
		
	if (WebUI.verifyElementPresent(findTestObject(orPath_TaxTypeFilingYear + '/select_FilingYear'), 30))
		{
			System.out.println('Filing Year drop down was found on the Estimated Tax Page')
		}
	else
		{
			System.out.println('Filing Year drop down was NOT found on the Estimated Tax Page')
		}
...
// Updates for August 2023
		WebUI.verifyOptionsPresent(findTestObject(orPath_TaxTypeFilingYear + '/select_PaymentType'),['Select', 'Corporate Income Tax',  'Fiduciary Tax', 'Personal Income Tax', 'PTE Non-Electing Non-S Corp', 'PTE Non-Electing S Corp', 'PTE Tax Electing Non-S Corp', 'PTE Tax Electing S Corp Tax'])
