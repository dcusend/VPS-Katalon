...
String dataFile = "RADTestData/Summary_Extension"
...
// Set Data FEIN
					...
					{
						WebUI.setEncryptedText(findTestObject(orPath_TaxInfo + '/input_TaxInfo_FeinSsn_New_2'), '1UdOed23yJD0bM3UEjTHrQ==')
						WebUI.setEncryptedText(findTestObject(orPath_TaxInfo + '/input_TaxInfo_RetypeFeinSsn_New_2'), '1UdOed23yJD0bM3UEjTHrQ==')
					}
					else
					{
						WebUI.setEncryptedText(findTestObject(orPath_TaxInfo + '/input_FederalEIN'), '1UdOed23yJD0bM3UEjTHrQ==')
						WebUI.setEncryptedText(findTestObject(orPath_TaxInfo + '/input_FederalEIN_ReEnter'), '1UdOed23yJD0bM3UEjTHrQ==')
					}	
...
// Verify static text on RAD Quarterly Estimated Summary page
					...
					if(WebUI.verifyTextPresent('Summary', true))
						...
						if(isRequiredTextPresent)
							{
									if(WebUI.verifyTextPresent('Extension Payments', true))
										{
											isRequiredTextPresent = true
										}
									else
					...
					if (feinSSN.equalsIgnoreCase("Y"))
						{
								...
								if(isRequiredTextPresent)
									{
											if(WebUI.verifyTextPresent('XXXXX5293', true))
												{
													isRequiredTextPresent = true
												}
											else
					...
					else
						{
								...
								if(isRequiredTextPresent)
									{
											if(WebUI.verifyTextPresent('XXXXXXX93', true))
												{
													isRequiredTextPresent = true
												}
											else
