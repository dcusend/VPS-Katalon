...
String dataFile = "RADTestData/BeforePayments_Estimated"
...
// Verify static text on RAD Quarterly Estimated Summary page
					 ...
					 * WebUI.verifyTextPresent('Quarterly Estimated Tax', true)
					 * WebUI.verifyTextPresent('Filing Year:', true)
					 * WebUI.verifyTextPresent(FilingYear, true) WebUI.verifyTextPresent('Period
					 * Ending:', true) WebUI.verifyTextPresent(PeriodEndingMonth, true)
