...
String fileLoc = "KatalonData/RADTestData/CRNNotZero.xlsx"
String nameSheet = "CRNNotZero"
String dataFile = "RADTestData/CRNNotZero"
...
// Tax Type dropdown is different
					...
					switch (Paymenttype)
					{
						...
						case "Existing Liability with Notice/Invoice Number":
								...
								WebUI.setText(findTestObject('Object Repository/RAD_Pages/TaxInfo_Page/input_MDCRegistrationEL'),"00000000")
...
//						break
						...
						case "New Tax Return Amount Due":
								...
								WebUI.scrollToElement(findTestObject(orPath_Amount + '/input__paymentAmount'), 2, FailureHandling.CONTINUE_ON_FAILURE)
								WebUI.setText(findTestObject(orPath_TaxInfo + '/input_MDCRegistration'),"00000000")
					...
					WebUI.verifyTextPresent('Enter valid MD Central Registration Number', true)
					
					if (WebUI.verifyTextPresent('Enter valid MD Central Registration Number', true))
						{
