...
String fileLoc = "KatalonData/RADTestData/JointFilerSSNmoreThan9Error.xlsx"
String nameSheet = "Sheet1"
String dataFile = "RADTestData/JointFilerSSNmoreThan9Error"
...
// Select Joint Filing Radio button
					...
					if (WebUI.verifyTextPresent('Please enter a valid SSN with 9 digits', true))
						...
						{
							println "Please enter a valid SSN with 9 digits text is NOT present on " + Taxtype + "page"
