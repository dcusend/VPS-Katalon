...
String fileLoc = "KatalonData/RADTestData/FEINandFEINSSNlessThan9Error.xlsx"
String nameSheet = "Sheet1"
String dataFile = "RADTestData/FEINandFEINSSNlessThan9Error"

def ExecuteTC, Taxtype, Paymenttype, feinSsn
			...
			if (ExecuteTC.equalsIgnoreCase("Y"))
				{
					...
					switch (Paymenttype)
					{
						...
						case "Quarterly Estimated Tax":
								if (feinSsn.equalsIgnoreCase("Y"))
									...
									{
										WebUI.setEncryptedText(findTestObject(orPath_TaxInfo + '/input_FederalEIN'), 'iGDxf8hSRT4=')
						...
						case "New Tax Return Amount Due":
								if (feinSsn.equalsIgnoreCase("Y"))
									...
									{
										WebUI.setEncryptedText(findTestObject(orPath_TaxInfo + '/input_FederalEIN-2'), 'iGDxf8hSRT4=')
					...
					if (feinSsn.equalsIgnoreCase("Y"))
					{
						if (WebUI.verifyTextPresent('Please enter a valid FEIN/SSN with 9 digits', true))
							{
