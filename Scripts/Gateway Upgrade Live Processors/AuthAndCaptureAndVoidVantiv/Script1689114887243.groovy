...
"open | Upgrade/version_2_0/auth.html |  | "
selenium.open("Upgrade/version_2_0/auth.html")
...
"pause | 2000 |  | "
	...
	if (WebUI.verifyTextPresent(("Transaction approved, no errors"), true))
		...
		GlobalVariable.VLinkSaleTranxID = traxID
			...
			"open | Upgrade/version_2_0/capture.html |  | "
			selenium.open("Upgrade/version_2_0/capture.html")
