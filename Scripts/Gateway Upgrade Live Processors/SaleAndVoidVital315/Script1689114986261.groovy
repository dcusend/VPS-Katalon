...
Map<String, String> saleFields = [
    'name=transaction_type':'104','name=message_version':'2.0C','name=application_id':'3000','name=username':'user3000','name=password':'pwd3000',
...
Map<String, String> voidFields = [
    'name=transaction_type':'106','name=message_version':'2.0C','name=application_id':'3000','name=username':'user3000','name=password':'pwd3000',
