...
'Generated date: 11-Jul-2023 04:22:39 PM'
...
"echo | Begin Sale And Credit And Void Vantiv |  | "
System.out.println("Begin Sale And Credit And Void Vantiv")
...
"type | name=amount | 0.14 | "
selenium.type("name=amount", "0.14")
		...
		if (WebUI.verifyTextPresent(("Transaction approved, no errors"), true))
			{
				...
				"open | Upgrade/version_2_0/CC_credit.html |  | "
				selenium.open("Upgrade/version_2_0/CC_credit.html")
				
				"type | name=transaction_type | 103 | "
				...
				if (WebUI.verifyTextPresent(("Transaction approved, no errors"), true))
					{
						...
						// Void the Credit Transaction
							...
							"type | name=transaction_id | tranIDVoid | "
							selenium.type("name=transaction_id", GlobalVariable.VLinkSaleTranxID)
							
							"type | name=original_transaction_type | 103 | "
							selenium.type("name=original_transaction_type", "103")
					...
					{
						println "Credit TRansasaction failed, can't void"
					}
			}
			
			else
			{
				println "Sale Transaction Failed, can't Credit or Void"
			}
