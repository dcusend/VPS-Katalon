...
'Generated date: 11-Jul-2023 04:22:48 PM'
...
"echo | Begin SaleAndVoidFDMS |  | "
System.out.println("Begin SaleAndVoidFDMS")
...
"type | name=application_id | 32 | "
selenium.type("name=application_id", "32")

"type | name=username | foo | "
selenium.type("name=username", "foo")

"type | name=password | bar | "
selenium.type("name=password", "bar")
