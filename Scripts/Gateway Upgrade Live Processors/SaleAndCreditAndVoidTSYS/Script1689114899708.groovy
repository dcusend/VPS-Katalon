...
Map<String, String> saleFields = [
    ...
    'name=country_id':'840','name=amount':'0.13','name=card_number':cc_Number,'name=card_exmo':expMo,'name=card_exyr':expYear,'name=cvv_data':'','name=cvv_state':'',
...
Map<String, String> creditFields = [
    'name=transaction_type':'103','name=message_version':'2.0C','name=application_id':'3899','name=username':'username','name=password':'password',
    'name=response_format':'fixed_width','name=amount':'0.13','name=order_number':'','name=tax_amount':'','name=charge_description':'',
