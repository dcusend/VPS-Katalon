...
Map<String, String> saleFields = [
    ...
    'name=country_id':'840','name=amount':'0.12','name=card_number':cc_Number,'name=card_exmo':expMo,'name=card_exyr':expYear,'name=cvv_data':'','name=cvv_state':'',
    'name=track_data':'','name=track_1_data':'','name=track_2_data':'','name=entry_mode':'manual','name=email':'','name=order_number':'','name=tax_amount':'6.57',
