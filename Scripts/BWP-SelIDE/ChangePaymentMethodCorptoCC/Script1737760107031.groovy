...
//softAssertion.assertEquals(Pattern.matches('selenium.getText("id=main-focus")', "Corporate Checking.*"), true)
...
selenium.waitForPageToLoad("30000")
Thread.sleep(20000);
//softAssertion.assertEquals(Pattern.matches('selenium.getText("id=main-focus")', "Authorization and Capture.*"), true)
//softAssertion.assertEquals(Pattern.matches('selenium.getText("id=main-focus")', "Visa.*"), true)
