...
selenium.type("name=application_id", "628")
...
selenium.type("name=billingName", ("Nicole Chloe").toString())
...
//softAssertion.assertEquals("This transaction is subject to a Convenience Fees of $1.00.", selenium.getText("css=p"))
//softAssertion.assertEquals("Payment Amount:", selenium.getText("//div[@id='main-focus']/div/center/form/table/tbody/tr/td/table/tbody/tr/td[2]"))
WebUI.verifyTextPresent(("Payment Amount:"), true)

//softAssertion.assertEquals("$10.00", selenium.getText("//div[@id='main-focus']/div/center/form/table/tbody/tr/td/table/tbody/tr/td[3]"))
softAssertion.assertEquals("Convenience Fees:", selenium.getText("//div[@id='main-focus']/div/center/form/table/tbody/tr/td/table/tbody/tr[2]/td[2]"))
//softAssertion.assertEquals("$1.00", selenium.getText("//div[@id='main-focus']/div/center/form/table/tbody/tr/td/table/tbody/tr[2]/td[3]"))
...
//softAssertion.assertEquals("$11.00", selenium.getText("//div[@id='main-focus']/div/center/form/table/tbody/tr/td/table/tbody/tr[4]/td[3]/b"))
//softAssertion.assertEquals("Two transactions will appear on your bank statement, one in the amount of $10.00 and one in the amount of $1.00.", selenium.getText("//div[@id='main-focus']/div/center/form/table/tbody/tr/td/p[2]"))
