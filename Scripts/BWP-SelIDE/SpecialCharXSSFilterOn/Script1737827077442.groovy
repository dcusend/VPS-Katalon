...
//softAssertion.assertEquals("TestvPortal Auto - Error The following error occurred:  Invalid characters Please&nbsp;&nbsp;click here to continue.", selenium.getText("//td[2]"))
WebUI.verifyTextPresent(("TestvPortal Auto - Error The following error occurred:  Invalid characters Please&nbsp;&nbsp;click here to continue."), true)