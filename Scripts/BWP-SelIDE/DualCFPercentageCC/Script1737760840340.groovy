...
/*
 * //softAssertion.
 * assertEquals("This transaction is subject to a Convenience Fees of $6.00.",
 ...
 * )) //softAssertion.assertEquals("$60.00", selenium.getText(
 ...
 * )) //softAssertion.assertEquals("$6.00", selenium.getText(
 ...
 * //softAssertion.assertEquals("$66.00", selenium.getText(
 * "//div[@id='main-focus']/div/center/form/table/tbody/tr/td/table/tbody/tr[4]/td[3]/b"
 * )) //softAssertion.
 * assertEquals("Two transactions will appear on your bank statement, one in the amount of $60.00 and one in the amount of $6.00."
 * , selenium.getText(
...
WebUI.verifyTextPresent(("60.00.*"), true)
WebUI.verifyTextPresent(("Convenience Fees:.*"), true)
WebUI.verifyTextPresent(("6.00.*"), true)
WebUI.verifyTextPresent(("Convenience Fees Type:.*"), true)
WebUI.verifyTextPresent(("Dual Transaction.*"), true)
WebUI.verifyTextPresent(("Total Amount:.*"), true)
WebUI.verifyTextPresent(("66.00.*"), true)
