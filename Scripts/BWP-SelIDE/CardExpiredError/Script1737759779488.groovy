...
WebUI.selectOptionByLabel(to("name=cardExpMonth"), "01", false)
WebUI.selectOptionByLabel(to("name=cardExpYear"), "2026", false)
...
WebUI.waitForPageLoad(pageLoadTimeoutSeconds)
//softAssertion.assertEquals("Invalid card expiration date", selenium.getText("//form[@id='process']/table/tbody/tr[21]/td[3]/span"))
