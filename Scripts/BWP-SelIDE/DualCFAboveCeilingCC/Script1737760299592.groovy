...
selenium.type("name=amount", ("80.00").toString())
...
softAssertion.assertEquals(Pattern.matches('selenium.getText("css=center")', "Total Amount:.*"), true)
softAssertion.assertEquals(Pattern.matches('selenium.getText("css=center")', "80.00.*"), true)
