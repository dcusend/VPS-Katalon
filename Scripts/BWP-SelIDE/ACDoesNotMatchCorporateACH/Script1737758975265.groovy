...
selenium.waitForPageToLoad("30000")
//softAssertion.assertEquals(Pattern.matches('selenium.getText("id=main-focus")', "The Account Number Information provided does not match. Please re-enter and confirm your Account Number information.*"), true)
