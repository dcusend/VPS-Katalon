...
//softAssertion.assertEquals(Pattern.matches('selenium.getText("id=process")', "This the CC Custom HTML. This text is to verify that a scroll bar is displayed in the payment application if a large text is entered into this textbox. This text is to verify that a scroll bar is displayed in the payment application if a large text is entered into this textbox. This text is to verify that a scroll bar is displayed in the payment application if a large text is entered into this textbox. This text is to verify that a scroll bar is displayed in the payment application if a large text is entered into this textbox.*"), true)
//softAssertion.assertEquals("This the CC Custom HTML. This text is to verify that a scroll bar is displayed in the payment application if a large text is entered into this textbox. This text is to verify that a scroll bar is displayed in the payment application if a large text is entered into this textbox. This text is to verify that a scroll bar is displayed in the payment application if a large text is entered into this textbox. This text is to verify that a scroll bar is displayed in the payment application if a large text is entered into this textbox.", selenium.getText("css=center > table > tbody > tr > td.vrelay-required"))

WebUI.verifyTextPresent(("This the CC Custom HTML. This text is to verify that a scroll bar is displayed in the payment application if a large text is entered into this textbox. This text is to verify that a scroll bar is displayed in the payment application if a large text is entered into this textbox. This text is to verify that a scroll bar is displayed in the payment application if a large text is entered into this textbox. This text is to verify that a scroll bar is displayed in the payment application if a large text is entered into this textbox.*"), true)
WebUI.verifyTextPresent(("This the CC Custom HTML. This text is to verify that a scroll bar is displayed in the payment application if a large text is entered into this textbox. This text is to verify that a scroll bar is displayed in the payment application if a large text is entered into this textbox. This text is to verify that a scroll bar is displayed in the payment application if a large text is entered into this textbox. This text is to verify that a scroll bar is displayed in the payment application if a large text is entered into this textbox."), true)
