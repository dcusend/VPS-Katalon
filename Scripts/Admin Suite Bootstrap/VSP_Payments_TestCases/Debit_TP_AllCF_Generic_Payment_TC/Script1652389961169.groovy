...
//def numOfRows, dataFile, nameSheet
	...
	numOfRows = findTestData('QA/Bootstrap/VSP-Payments-TestData/ACH-Payments-Debit').getRowNumbers()
	println("Number of Records: " + numOfRows)
	dataFile = "QA/Bootstrap/VSP-Payments-TestData/ACH-Payments-Debit"
			...
			if (ExecuteTC.equalsIgnoreCase("Y"))
				{
					...
					// Verify Static text
						...
						tranType = findTestData(dataFile).getValue('TranType', row)
