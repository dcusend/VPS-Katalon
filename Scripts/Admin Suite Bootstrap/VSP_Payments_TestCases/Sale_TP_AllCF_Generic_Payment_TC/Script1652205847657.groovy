...
//def numOfRows, dataFile, nameSheet
	...
	nameSheet = "CC-Payments-Sale"
	numOfRows = findTestData('QA/Bootstrap/VSP-Payments-TestData/CC-Payments-Sale').getRowNumbers()
	println("Number of Records: " + numOfRows)
	dataFile = "QA/Bootstrap/VSP-Payments-TestData/CC-Payments-Sale"
			...
			if (ExecuteTC.equalsIgnoreCase("Y"))
				{
					...
					// GetData
						criteria = findTestData(dataFile).getValue('ProfileName', row)
					...
					// Verify Static text
						...
						WebUI.verifyTextPresent(("Sale"), true)
					...
					// Verify Static text
						...
						switch(appName)
							{
								case "a_Access AutoSingleCFtpQA":
									// For Single CF
								...
								case "a_Access AutoSingleCFtpDemo":
									// For Single CF
										WebUI.verifyTextPresent('5.00', true)
										WebUI.verifyTextPresent('Single Transaction', true)
										WebUI.verifyTextPresent('7.50', true)
								...
								case "a_Access AutoDualCFtpDemo":
									// For Dual CF
										WebUI.verifyTextPresent('5.00', true)
										WebUI.verifyTextPresent('Dual Transaction', true)
										WebUI.verifyTextPresent('7.50', true)
