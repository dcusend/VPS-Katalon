...
String path_CreateProfile = "Object Repository/AdminSuiteBootstrap_Pages/VSP_Bootstrap/CreateProfile/"
	...
	// Verify Save and Add Credit Card button is not present
	WebUI.verifyElementNotPresent(findTestObject(path_CreateProfile + 'button_Save  Add Credit Card'), 30)
	
	
	// Verify Save and Add ACH button is present
