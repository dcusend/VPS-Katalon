...
//def numOfRows, dataFile, nameSheet
	...
	nameSheet = "AddACHMRF"
	numOfRows = findTestData('QA/Bootstrap/VSP-Profile-TestData/AddACHMRF').getRowNumbers()
	println("Number of Records: " + numOfRows)
	dataFile = "QA/Bootstrap/VSP-Profile-TestData/AddACHMRF"
			...
			if (ExecuteTC.equalsIgnoreCase("Y"))
				{
					...
					// Select Business Checking from dropdown
						WebUI.selectOptionByLabel(findTestObject(path_Add_ACH + 'select_PaymentType'), 'Business Checking', true)
					...
					// Verify the Error Messages
						...
						WebUI.verifyTextPresent(("A customer's first name is required"), true)
						WebUI.verifyTextPresent(("A customer's last name is required"), true)
						WebUI.verifyTextPresent(("Nickname is required"), true)
						WebUI.verifyTextPresent(("RTN length invalid  Invalid Routing Transit Number"), true)
						WebUI.verifyTextPresent(("Account Number is required"), true)
						WebUI.verifyTextPresent(("Must provide a company name"), true)
