...
String path_Dashboard = "Object Repository/AdminSuiteBootstrap_Pages/Dashboard_Bootstrap/"
	...
	WebUI.verifyElementVisible(findTestObject(path_Dashboard + 'a_Logout'))
	WebUI.verifyElementPresent(findTestObject(path_Dashboard + 'a_Logout'), 30)
	
	
	WebUI.verifyElementPresent(findTestObject(path_Dashboard + 'a_My Account'), 30)
	...
	WebUI.verifyTextPresent('Velocity Payment System Version 2022-1 - Copyright © 2022 Govolution', true)
