		...
		WebUI.click(findTestObject(path_Dashboard + 'a_HelloWorld3'))
			...
			WebUI.click(findTestObject(path_VT + 'button_Authorization  Capture (Sale)'))
				...
				WebUI.click(saleKeyboardEntryLink)
					...
					WebUI.verifyElementVisible(findTestObject(path_SaleKB + 'input_userDefined5'))
					WebUI.verifyElementPresent(findTestObject(path_SaleKB + 'input_userDefined5'), 30)
					
					WebUI.verifyElementVisible(findTestObject(path_SaleKB + 'input_userDefined6'))
					WebUI.verifyElementPresent(findTestObject(path_SaleKB + 'input_userDefined6'), 30)
