...
def numOfRows, dataFile, nameSheet
	...
	nameSheet = "Capture-MoreError"
	numOfRows = findTestData('QA/Bootstrap/VT-TestData/VT-Misc-Data-Capture-MoreError').getRowNumbers()
	println("Number of Records: " + numOfRows)
	dataFile = "QA/Bootstrap/VT-TestData/VT-Misc-Data-Capture-MoreError"
			...
			if (ExecuteTC.equalsIgnoreCase("Y"))
				{
					...
					Thread.sleep(2000)
						...
						if (WebUI.verifyTextPresent('Transaction Successful', true))
						{
							...
							WebUI.verifyTextPresent('Reason: The amount you attempted to capture exceeds the authorized amount. Please lower the amount and try again.', true)
							WebUI.verifyTextPresent('Pleaseclick hereto continue', true)
