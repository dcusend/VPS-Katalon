...
//#################################################
//
//This Test Case does a Sale and Credit Keyboard Entry
//using VT-SaleCreditData-SingleCF-Generic Data file
...
def numOfRows, dataFile, nameSheet
	...
	nameSheet = "VT-SaleCredit-SingleCF-Generic"
	numOfRows = findTestData('QA/Bootstrap/VT-TestData/VT-SaleCreditData-SingleCF-Generic').getRowNumbers()
	println("Number of Records: " + numOfRows)
	dataFile = "QA/Bootstrap/VT-TestData/VT-SaleCreditData-SingleCF-Generic"
						...
						if (WebUI.verifyTextPresent('Transaction Successful', true))
							{
								...
								def partialCardNumber = findTestData(dataFile).getValue('AutoCreditNumber', row)
								WebUI.setText(findTestObject(path_TranxDetails + 'input_cardMiddle'),partialCardNumber)
