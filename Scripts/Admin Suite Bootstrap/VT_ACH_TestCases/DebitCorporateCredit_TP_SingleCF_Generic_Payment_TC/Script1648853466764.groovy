...
def numOfRows, dataFile, nameSheet
	...
	nameSheet = "VT-C-DebitCredit-SingleCF-Gener"
	numOfRows = findTestData('QA/Bootstrap/VT-ACH-TestData/VT-DebitCreditDataCorp-SingleCF-Generic').getRowNumbers()
	println("Number of Records: " + numOfRows)
	dataFile = "QA/Bootstrap/VT-ACH-TestData/VT-DebitCreditDataCorp-SingleCF-Generic"
