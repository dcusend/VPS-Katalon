...
def numOfRows, dataFile, nameSheet
	...
	numOfRows = findTestData('QA/Bootstrap/VT-ACH-TestData/VT-DebitCreditDataCorp-NoCF-Generic').getRowNumbers()
	println("Number of Records: " + numOfRows)
	dataFile = "QA/Bootstrap/VT-ACH-TestData/VT-DebitCreditDataCorp-NoCF-Generic"
