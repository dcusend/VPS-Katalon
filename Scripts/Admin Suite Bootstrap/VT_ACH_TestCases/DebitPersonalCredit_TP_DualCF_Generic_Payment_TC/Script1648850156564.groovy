...
def numOfRows, dataFile, nameSheet
	...
	nameSheet = "VT-P-DebitCredit-DualCF-Generic"
	numOfRows = findTestData('QA/Bootstrap/VT-ACH-TestData/VT-DebitCreditData-DualCF-Generic').getRowNumbers()
	println("Number of Records: " + numOfRows)
	dataFile = "QA/Bootstrap/VT-ACH-TestData/VT-DebitCreditData-DualCF-Generic"
