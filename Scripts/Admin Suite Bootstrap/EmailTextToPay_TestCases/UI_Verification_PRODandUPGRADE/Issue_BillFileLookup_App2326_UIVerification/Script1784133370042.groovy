...
WebUI.selectOptionByLabel(findTestObject('Object Repository/AdminSuiteBootstrap_Pages/ManageEmailOrTextToPay/BillFileLookup/dd_PaymentApplication'),'BBP Parking Fees GovTest' ,false)
WebUI.delay(2)
...
WebUI.verifyTextPresent('Lookup3 Label', true)
