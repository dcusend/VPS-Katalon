...
WebUI.verifyElementPresent(findTestObject(path_Operation_Reports + 'btn_payment_tender_cc'), 30)

WebUI.verifyElementPresent(findTestObject(path_Operation_Reports + 'btn_payment_tender_ach'), 30)
