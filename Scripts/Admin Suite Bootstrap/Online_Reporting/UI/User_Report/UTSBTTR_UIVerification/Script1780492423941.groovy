...
WebUI.click(findTestObject(path_User_Reports + 'a_User Transaction Summary By Tender Type Report'))

WebUI.verifyTextPresent('User Transaction Summary By Tender Type Report', false)
