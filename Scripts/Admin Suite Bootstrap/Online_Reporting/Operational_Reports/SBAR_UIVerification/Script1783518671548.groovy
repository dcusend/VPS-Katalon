...
WebUI.click(findTestObject(path_Operation_Reports + 'a_Settlement Batch Activity Report'))

WebUI.delay(GlobalVariable.shortTimeDelay)

WebUI.verifyTextPresent('Settlement Batch Activity Report', false)

//Step 1 

WebUI.verifyTextPresent('Please select on which to base this report.', false)

WebUI.verifyTextPresent('Customer:', false)

WebUI.verifyOptionsPresent(findTestObject(path_Operation_Reports + 'select_customer_Id'),['imtiaz'])

WebUI.verifyTextPresent('Type:', false)

WebUI.verifyElementPresent(findTestObject(path_Operation_Reports + 'select_card_type'), 30)
...
WebUI.verifyElementPresent(findTestObject(path_Operation_Reports + 'btn_cont_submit'), 30)
