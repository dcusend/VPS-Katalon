...
WebUI.click(findTestObject(path_Audit_Reports + 'a_User Actions Report'))

WebUI.verifyTextPresent('User Actions Report', false)
...
WebUI.verifyElementPresent(findTestObject(path_Audit_Reports + 'btn_Continue'), 30)
