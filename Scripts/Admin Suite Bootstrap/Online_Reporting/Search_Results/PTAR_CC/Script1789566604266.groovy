...
WebUI.setText(findTestObject(path_Operation_Reports + 'card_prefix'), '37')

WebUI.setText(findTestObject(path_Operation_Reports + 'card_suffix'), '1003')
...
WebUI.verifyTextPresent('37**********1003.', false)
