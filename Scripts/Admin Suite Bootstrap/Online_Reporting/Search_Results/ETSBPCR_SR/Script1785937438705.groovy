...
WebUI.click(findTestObject(path_Operation_Reports + 'a_Enterprise Transaction Summary Report by Payment Channel'))

WebUI.delay(GlobalVariable.shortTimeDelay)

WebUI.verifyTextPresent('Enterprise Transaction Summary By Payment Channel Report', false)
...
WebUI.verifyTextPresent('Payment Channel', false)
...
WebUI.verifyTextPresent('Agent/Clerk', false)

WebUI.verifyTextPresent('POS', false)
