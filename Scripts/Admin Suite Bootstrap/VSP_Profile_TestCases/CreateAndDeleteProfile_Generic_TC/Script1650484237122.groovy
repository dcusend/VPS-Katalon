...
//def numOfRows, dataFile, nameSheet
	...
	nameSheet = "CreateProfile"
	numOfRows = findTestData('QA/Bootstrap/VSP-Profile-TestData/CreateAndDeleteProfile').getRowNumbers()
	println("Number of Records: " + numOfRows)
	dataFile = "QA/Bootstrap/VSP-Profile-TestData/CreateAndDeleteProfile"
