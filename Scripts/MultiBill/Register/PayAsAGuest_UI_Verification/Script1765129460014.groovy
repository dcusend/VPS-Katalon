...
// Verify Pay as a Guest Static Text and Elements
...
// Select Pay as a Guest button link
		...
		if (WebUI.verifyTextPresent('Select Payment Method', false, FailureHandling.STOP_ON_FAILURE))
			{
				...
				println "On Select Payment Method Page, Continue Verification"
				
				WebUI.verifyTextPresent('Please Choose the Method of Payment', false, FailureHandling.CONTINUE_ON_FAILURE)
				...
				{
					KeywordUtil.markFailed("Not on Select Payment Method Page, check for a possible defect")
					println "Not on Select Payment Method Page, check for a possible defect"
				}
