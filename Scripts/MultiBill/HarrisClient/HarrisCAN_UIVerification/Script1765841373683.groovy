...
def multibillHarrisCANURL=GlobalVariable.MultiBillHarrisCANURL

//searchString = "Lenna Paprocki"
//searchString = GlobalVariable.RegisterSearchString

WebUI.openBrowser(multibillHarrisCANURL)
...
def totalSearchByOptions = WebUI.getNumberOfTotalOption(findTestObject('Object Repository/MultiBill/MultibillSearch/dd_Harris_SearchBy'))
		...
		if (WebUI.verifyEqual(totalSearchByOptions, 3))
		{
		...
		WebUI.verifyOptionsPresent(findTestObject('Object Repository/MultiBill/MultibillSearch/dd_Harris_SearchBy'),['Payer Account Number','Payer Name','Payer Address'])
