...
'Generated date: 11-Jul-2023 04:22:42 PM'
...
"echo | Begin AuthAndCaptureAndVoidVantiv |  | "
System.out.println("Begin AuthAndCaptureAndVoidVantiv")

"open | Production/version_2_0/auth.html |  | "
selenium.open("Production/version_2_0/auth.html")

"type | name=transaction_type | 100 | "
...
"type | name=application_id | 3576 | "
selenium.type("name=application_id", "3576")
...
"type | name=card_name | James Smithy | "
selenium.type("name=card_name", "James Smithy")
...
"type | name=amount | 0.16 | "
selenium.type("name=amount", "0.16")
...
selenium.type("name=card_number", cc_Number)
selenium.type("name=card_exmo", expMo)
selenium.type("name=card_exyr", expYear)
...
Thread.sleep(2000)
	...
	if (WebUI.verifyTextPresent(("Transaction approved, no errors"), true))
		...
		GlobalVariable.VLinkSaleTranxID = traxID
			...
			"open | Production/version_2_0/capture.html |  | "
			selenium.open("Production/version_2_0/capture.html")
			
			"type | name=transaction_type | 102 | "
			...
			"type | name=remittance_id | remIDCap | "
			...
			if (WebUI.verifyTextPresent(("Transaction approved, no errors"), true))
				{
					...
					// Void the Captured Transaction
							...
							"open | Production/version_2_0/CC_void.html |  | "
							selenium.open("Production/version_2_0/CC_void.html")
							...
							"type | name=transaction_id | tranIDCap | "
							selenium.type("name=transaction_id", GlobalVariable.VLinkSaleTranxID)
							
							"type | name=original_transaction_type | 102 | "
							selenium.type("name=original_transaction_type", "102")
				...
				{
					println "Capture TRansasaction failed, can't void"
				}
			...
			{
				println "Auth Transaction Failed, can't Capture or Void"
			}
