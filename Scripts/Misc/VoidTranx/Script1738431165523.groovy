...
def numOfRows, dataFile, nameSheet
	...
	nameSheet = "VoidTranx"
	numOfRows = findTestData('Misc/VoidTranx').getRowNumbers()
	println("Number of Records: " + numOfRows)
	dataFile = "Misc/VoidTranx"
			...
			if (ExecuteTC.equalsIgnoreCase("Y"))
				{
					...
					//WebUI.setText(findTestObject('Object Repository/VLink/Page_CCSale/txt_RemID'),genRemID)
							...
							// Void the Sale
							 ...
							 // selenium.open("https://dev-algorithm.govolution.com/vlinktest/Production/version_2_0/CC_void.html")
							...
							//  WebUI.openBrowser(
							 // "https://dev-algorithm.govolution.com/vlinktest/Production/version_2_0/CC_void.html")
							  
							  selenium.open("https://dev-algorithm.govolution.com/vlinktest/Production/version_2_0/CC_void.html")
							  
							  
							  selenium.type("name=remittance_id", remID)
							  //selenium.click("name=application_id") 
							  ...
							  //selenium.click("name=transaction_id") 
							 ...
							 // selenium.click("name=track_data") 
