	...
	for (def row = 1; row <= numOfRows; row++)
		{
			...
			System.out.println('Begin Record Number: ' + row)
				...
				// setData for CC Payment Entry Page
					...
					WebUI.setText(findTestObject('Object Repository/BWP_Bootstrap/Page_CCPaymentEntry/txt_Amount_modify'),"10.50")
					WebUI.delay(30)
							
					if (WebUI.verifyTextPresent("Amount is greater than maximum", false))
						{
							println "Max Amount Error message shown"
							KeywordUtil.markPassed("Max Amount Error message shown")
							resText = "Pass"
						...
						{
							println "Max Amount Error message not shown"
