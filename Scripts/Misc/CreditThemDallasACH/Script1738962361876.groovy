...
def numOfRows, dataFile, nameSheet
	...
	nameSheet = "CreditThemDallasACH"
	numOfRows = findTestData('Misc/CreditThemDallasACH').getRowNumbers()
	println("Number of Records: " + numOfRows)
	dataFile = "Misc/CreditThemDallasACH"
			...
			if (ExecuteTC.equalsIgnoreCase("Y"))
				{
					...
					def amount = findTestData(dataFile).getValue('Amount', row)
							...
							selenium.open("https://dev-algorithm.govolution.com/vlinktest/Production/version_2_0/ACH_credit.html")
