...
String fileLoc = "KatalonData/ABPTestData/ABPTestData.xlsx"
 String path = fileLoc
 nameSheet = "UiVerificationSPRecDeferred"
 ...
 paymentMethod = "Bridges"
 paymentPlanType = "RecurringAmount"
 paymentPlanFrequency = "Deferred"
						 ...
						 for(def item in stringArray)
							 ...
							 if(WebUI.verifyTextPresent(item.trim(),false)) {
								...
								if (isRequiredTextPresent) {
									...
									{
										println "Some texts are missing on the Scheduled Payment page"
