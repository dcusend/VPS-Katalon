...
//Part B- Changing field values of Owner
				...
				def ownerData = CustomKeywords.'abpPages.UserListPage_1stUser.setDataOwnerFirstNameOwnerLastName'()		
				println("First Name = " + ownerData.firstName)
				println("Last Name = " + ownerData.lastName)
									
				CustomKeywords.'abpPages.UserListPage_1stUser.setDataOwnerEmailConfirmEmail'(newEmail)
...
//Part C- Verify Owner's fields name on 'User List' page
				...
				WebUI.delay(2)				
				CustomKeywords.'abpPages.UserListPage_1stUser.verifyEditedOwnerUser'(selectedUsername, ownerData.firstName, ownerData.lastName, "Profile Owner")
