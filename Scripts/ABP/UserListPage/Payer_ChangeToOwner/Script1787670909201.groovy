...
//Part B- Change Payer to Profile Owner
...
//Part C- Verifying user's Role after changing it from Payer to Profile Owner
				
				WebUI.delay(2)
				CustomKeywords.'abpPages.UserListPage.verifyUserRole'(selectedUsername, 'Profile Owner')
								
				
//Part D- Delete the newly created Payer turned Profile Owner.
