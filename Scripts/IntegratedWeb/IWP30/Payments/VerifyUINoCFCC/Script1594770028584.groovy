...
// Get Verification data from Excel spreadsheet
		...
		def Amount = findTestData('IWPTestData/VerifyUINoCFCCTestData').getValue('Amount', row)
		def UDF2 = findTestData('IWPTestData/VerifyUINoCFCCTestData').getValue('UDF2', row)
		def UDF3 = findTestData('IWPTestData/VerifyUINoCFCCTestData').getValue('UDF3', row)
		def UDF7 = findTestData('IWPTestData/VerifyUINoCFCCTestData').getValue('UDF7', row)
		def UDF8 = findTestData('IWPTestData/VerifyUINoCFCCTestData').getValue('UDF8', row)
		def CName = findTestData('IWPTestData/VerifyUINoCFCCTestData').getValue('Name', row)
		...
		def AL1 = findTestData('IWPTestData/VerifyUINoCFCCTestData').getValue('AL1', row)
		def AL2 = findTestData('IWPTestData/VerifyUINoCFCCTestData').getValue('AL2', row)
		...
		def CZIP = findTestData('IWPTestData/VerifyUINoCFCCTestData').getValue('ZIP', row)
		def Email = findTestData('IWPTestData/VerifyUINoCFCCTestData').getValue('Email', row)
