	...
	if (ExecuteTC.equalsIgnoreCase("Y"))
		{
			...
			WebUI.verifyTextPresent(('Check Information:'),false)
			
			WebUI.verifyTextPresent(('Personal'),false)
			...
			WebUI.verifyTextPresent(('Name of Account:'),false)
...
//			WebUI.verifyTextPresent(('NH'),false)
			...
			WebUI.verifyTextPresent(('AutoPay'),false)
