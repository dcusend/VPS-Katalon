...
def numOfRows, dataFile, nameSheet, dataFileEmulator, isRequiredTextPresent = false
	...
	nameSheet = "VerifyReceiptPageLabelsCorp"
	dataFile = "IWPTestData/IWP25VerifyReceiptPageLabelsCorp"
			...
			if (ExecuteTC.equalsIgnoreCase("Y"))
				{
					...
					// Select CorporateCheck Payment Method
					...
					Thread.sleep(5000)
						...
						if(isRequiredTextPresent) {
							if(WebUI.verifyTextPresent("Company's Name:", false)) {
								isRequiredTextPresent = true
							}
							else {
								isRequiredTextPresent = false
