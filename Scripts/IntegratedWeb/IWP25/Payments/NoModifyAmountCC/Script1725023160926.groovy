...
def numOfRows, dataFile, nameSheet, dataFileEmulator
	...
	dataFile = "IWPTestData/IWP25NoModifyAmountCC"
...
//					Thread.sleep(10000)
					...
					if(WebUI.verifyElementNotPresent(findTestObject('Object Repository/IWP30/Page_CCPaymentEntry/Amount'),30) && WebUI.verifyTextPresent( "\$10.50", false)) {
