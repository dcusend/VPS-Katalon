...
def numOfRows, dataFile, nameSheet, dataFileEmulator
	...
	nameSheet = "MinAmountErrorPS"
	dataFile = "IWPTestData/IWP25MinAmountErrorPS"
			...
			if (ExecuteTC.equalsIgnoreCase("Y"))
				{
					...
					Thread.sleep(10000)
					if (WebUI.verifyTextPresent("Amount is less than minimum", false))
						{
							println "Min Amount Error message shown"
						...
						{
							println "Min Amount Error message not shown"
