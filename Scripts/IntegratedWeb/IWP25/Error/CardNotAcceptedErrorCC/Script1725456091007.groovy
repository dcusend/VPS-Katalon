...
def numOfRows, dataFile, nameSheet, dataFileEmulator
	...
	nameSheet = "CardNotAcceptedErrorCC"
	dataFile = "IWPTestData/IWP25CardNotAcceptedErrorCC"
			...
			if (ExecuteTC.equalsIgnoreCase("Y"))
				{
					...
					Thread.sleep(10000)
					if (WebUI.verifyTextPresent("Card number is invalid. Please enter a different credit card number.", false))
						{
							println "Card number is invalid message shown"
						...
						{
							println "Card number is invalid message not shown"
