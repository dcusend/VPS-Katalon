...
selenium.waitForPageToLoad("30000")
//softAssertion.assertEquals(Pattern.matches('selenium.getText("css=div.main_col")', "This card type is not accepted, please enter a different credit or debit card number.*"), true)
