...
println('Begin Test: VerifyConfirmationPageLabelsCC')
...
WebUI.verifyTextPresent('Make a Real Estate Payment', true)
...
WebUI.verifyTextPresent('Card Type:', true)
...
WebUI.verifyTextPresent('Billing Information:', true)
...
println('End Test: VerifyConfirmationPageLabelsCC')