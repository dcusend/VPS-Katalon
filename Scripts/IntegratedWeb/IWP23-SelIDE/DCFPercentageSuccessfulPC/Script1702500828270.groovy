...
println("Begin Test: DCFPercentageSuccessfulPC")
...
selenium.waitForPageToLoad("30000")
selenium.type("name=amount", ("100.00").toString())
...
/*
 * //softAssertion.
 * assertEquals("This transaction is subject to a Convenience Fees of $10.00.",
 * selenium.getText("css=td > p")) softAssertion.assertEquals("Payment Amount:",
 * selenium.getText("//td[2]")) //softAssertion.assertEquals("$100.00",
 * selenium.getText("//td[3]")) softAssertion.assertEquals("Convenience Fees:",
 * selenium.getText("//tr[2]/td[2]")) //softAssertion.assertEquals("$10.00",
 * selenium.getText("//tr[2]/td[3]"))
 * softAssertion.assertEquals("Total Amount:", selenium.getText("css=b"))
 * //softAssertion.assertEquals("$110.00", selenium.getText("//td[3]/b"))
 * //softAssertion.
 * assertEquals("Two transactions will appear on your bank statement, one in the amount of $100.00 and one in the amount of $10.00."
...
WebUI.verifyTextPresent(("Two transactions will appear on your bank statement, one in the amount of \$100.00 and one in the amount of \$10.00"), false)
 ...
 * "css=div.main_col")', "100.00.*"), true)
 * softAssertion.assertEquals(Pattern.matches('selenium.getText(
 * "css=div.main_col")', "10.00.*"), true)
 * softAssertion.assertEquals(Pattern.matches('selenium.getText(
 * "css=div.main_col")', "Dual Transaction.*"), true)
 * softAssertion.assertEquals(Pattern.matches('selenium.getText(
 * "css=div.main_col")', "110.00.*"), true)
 * softAssertion.assertEquals(Pattern.matches('selenium.getText(
...
println("End Test: DCFPercentageSuccessfulPC")
