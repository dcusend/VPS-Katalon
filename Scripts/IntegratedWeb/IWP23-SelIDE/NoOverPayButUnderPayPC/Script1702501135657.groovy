...
println("Begin Test: NoOverPayButUnderPayPC")
...
selenium.type("name=application_id", "652")
...
//softAssertion.assertEquals("$2.00", selenium.getText("css=td.payor_opt"))
...
//softAssertion.assertEquals(Pattern.matches('selenium.getText("css=div.main_col")', "2.00.*"), true)

WebUI.verifyTextPresent(("Successful Payment Receipt"), true)
WebUI.verifyTextPresent(("\$2.00"), false)

println("End Test: NoOverPayButUnderPayPC")
