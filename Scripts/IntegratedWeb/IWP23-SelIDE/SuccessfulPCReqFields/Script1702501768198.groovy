...
println("Begin Test: SuccessfulPCReqFields")
 ...
 * softAssertion.assertEquals("udf3 data", selenium.getText("//tr[5]/td[3]"))
 * softAssertion.assertEquals("Tennis", selenium.getText("//tr[6]/td[3]"))
 * softAssertion.assertEquals("Mike", selenium.getText("//tr[9]/td[3]"))
 * softAssertion.assertEquals("Chingiti", selenium.getText("//tr[10]/td[3]"))
 * softAssertion.assertEquals(Pattern.matches('selenium.getText("//tr[11]/td[3]"
 * )', "2691.*"), true)
 ...
 * selenium.getText("//tr[15]/td[3]")) softAssertion.assertEquals("ARLINGTON",
 * selenium.getText("//tr[16]/td[3]")) softAssertion.assertEquals("Virginia",
 * selenium.getText("//tr[17]/td[3]")) softAssertion.assertEquals("22201",
 * selenium.getText("//tr[18]/td[3]"))
 * softAssertion.assertEquals(Pattern.matches('selenium.getText("//tr[20]/td[3]"
 * )', "agency@test.com.*"), true)
...
WebUI.verifyTextPresent(("Mike"), true)
WebUI.verifyTextPresent(("Chingiti"), true)
 ...
 * softAssertion.assertEquals(selenium.isTextPresent("css=div.main_col"), false)
 * softAssertion.assertEquals(Pattern.matches('selenium.getText(
...
println("End Test: SuccessfulPCReqFields")
