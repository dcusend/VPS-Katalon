...
println("Begin Test: TermsAndConditionsCC")
...
//softAssertion.assertEquals(Pattern.matches('selenium.getText("css=div.main_col")', "These are Customer CC Terms.*"), true)
//softAssertion.assertEquals(Pattern.matches('selenium.getText("css=div.main_col")', "These are CC Custom HTML.*"), true)

WebUI.verifyTextPresent(("These are Customer CC Terms"), true)
WebUI.verifyTextPresent(("These are CC Custom HTML"), true)
 ...
 * softAssertion.assertEquals("4/2028", selenium.getText("//tr[14]/td[3]"))
 ...
 * softAssertion.assertEquals(Pattern.matches('selenium.getText(
 * "css=div.main_col")', "These are CC Custom HTML.*"), true)
 */
...
println("End Test: TermsAndConditionsCC")
