...
println('Begin Test: VerifyConfirmationPageLabelsPC')
...
WebUI.verifyTextPresent('Confirm Payment Information', true)
...
WebUI.verifyTextPresent('UDF1 Label:', true)
WebUI.verifyTextPresent('UDF2 Label:', true)
WebUI.verifyTextPresent('UDF3 Label:', true)
WebUI.verifyTextPresent('UDF4 Label:', true)
WebUI.verifyTextPresent('UDF5 Label:', true)
WebUI.verifyTextPresent('Account Information:', true)
WebUI.verifyTextPresent('First Name on Check:', true)
WebUI.verifyTextPresent('Last Name on Check:', true)
...
println('End Test: VerifyConfirmationPageLabelsPC')