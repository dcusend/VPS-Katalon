...
println("Begin Test: NoModifyAmountPC")
...
selenium.type("name=application_id", "654")
...
selenium.waitForPageToLoad("30000")
Thread.sleep(8000);
//softAssertion.assertEquals(Pattern.matches('selenium.getText("css=div.main_col")', "10.00.*"), true)

WebUI.verifyTextPresent(("\$10.00"), false)

println("End Test: NoModifyAmountPC")
