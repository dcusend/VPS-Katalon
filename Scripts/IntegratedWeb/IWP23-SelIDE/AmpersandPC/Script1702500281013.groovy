...
println("Begin Test: AmpersandPC")
...
selenium.type("name=billingFirstname", ("FirstName & Son M").toString())
selenium.type("name=billingLastname", ("LastName & Son MaintenanceA").toString())
 ...
 * softAssertion.assertEquals("FirstName & Son M",
 * selenium.getText("//tr[11]/td[3]"))
 * softAssertion.assertEquals("LastName & Son MaintenanceA",
 * selenium.getText("//tr[12]/td[3]"))
 * softAssertion.assertEquals("AddLine1 & Son Mai Johnson & Son Mai Johnson & S"
 * , selenium.getText("//tr[16]/td[3]"))
 * softAssertion.assertEquals("AddLine2 & Son Mai Johnson & Son Mai Johnson & S"
...
WebUI.verifyTextPresent(("FirstName & Son M"), true)
WebUI.verifyTextPresent(("LastName & Son MaintenanceA"), true)
 ...
 * softAssertion.assertEquals(Pattern.matches('selenium.getText(
 * "css=div.main_col")', "FIRSTNAME & SON M LASTNAME & SON MAINTENANCEA.*"),
 * true) softAssertion.assertEquals(Pattern.matches('selenium.getText(
 * "css=div.main_col")', "AddLine1 & Son Mai Johnson & Son Mai Johnson & S.*"),
 * true) softAssertion.assertEquals(Pattern.matches('selenium.getText(
 * "css=div.main_col")', "AddLine2 & Son Mai Johnson & Son Mai Johnson & S.*"),
 * true)
 */
...
WebUI.verifyTextPresent(("FIRSTNAME & SON M LASTNAME & SON MAINTENANCEA"), true)
WebUI.verifyTextPresent(("AddLine1 & Son Mai Johnson & Son Mai Johnson & S"), true)
WebUI.verifyTextPresent(("AddLine2 & Son Mai Johnson & Son Mai Johnson & S"), true)


println("End Test: AmpersandPC")
