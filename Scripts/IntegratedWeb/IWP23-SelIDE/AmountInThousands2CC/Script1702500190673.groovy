...
println("Begin Test: AmountInThousands2CC")
...
selenium.waitForPageToLoad("30000")
selenium.type("name=amount", ("4,500.00").toString())
...
WebUI.verifyTextPresent(("\$4,500.00"), false)

//softAssertion.assertEquals("$4,500.00", selenium.getText("css=td.payor_opt"))
selenium.click("name=confirmNotifyAction")
selenium.waitForPageToLoad("30000")
Thread.sleep(8000);
//softAssertion.assertEquals("Successful Payment Receipt", selenium.getText("css=td > h2"))
//softAssertion.assertEquals(Pattern.matches('selenium.getText("css=div.main_col")', "4,500.00.*"), true)

WebUI.verifyTextPresent(("Successful Payment Receipt"), true)
WebUI.verifyTextPresent(("\$4,500.00"), false)

println("End Test: AmountInThousands2CC")
