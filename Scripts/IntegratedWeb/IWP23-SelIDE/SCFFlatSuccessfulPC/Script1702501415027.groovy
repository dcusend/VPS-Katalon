...
println("Begin Test: SCFFlatSuccessfulPC")
 ...
 * softAssertion.assertEquals(Pattern.matches('selenium.getText(
 * "css=div.main_col")', "2.00.*"), true)
 * softAssertion.assertEquals(Pattern.matches('selenium.getText(
 * "css=div.main_col")', "Single Transaction.*"), true)
 * softAssertion.assertEquals(Pattern.matches('selenium.getText(
 * "css=div.main_col")', "12.50.*"), true)
 * softAssertion.assertEquals(Pattern.matches('selenium.getText(
...
println("End Test: SCFFlatSuccessfulPC")
