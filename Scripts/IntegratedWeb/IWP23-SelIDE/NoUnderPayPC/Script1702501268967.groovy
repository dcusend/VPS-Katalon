...
println("Begin Test: NoUnderPayPC")
...
selenium.waitForPageToLoad("30000")
selenium.type("name=amount", ("2.00").toString())
...
selenium.waitForPageToLoad("30000")
//softAssertion.assertEquals(Pattern.matches('selenium.getText("css=div.main_col")', "Payment amounts less than.*"), true)
//softAssertion.assertEquals(Pattern.matches('selenium.getText("css=div.main_col")', "are not accepted.*"), true)

WebUI.verifyTextPresent(("Payment amounts less than"), true)
WebUI.verifyTextPresent(("are not accepted"), true)

println("End Test: NoUnderPayPC")
