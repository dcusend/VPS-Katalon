...
println("Begin Test: NoOverPayCC")
...
selenium.waitForPageToLoad("30000")
//softAssertion.assertEquals(Pattern.matches('selenium.getText("css=div.main_col")', "Payment amounts more than.*"), true)
