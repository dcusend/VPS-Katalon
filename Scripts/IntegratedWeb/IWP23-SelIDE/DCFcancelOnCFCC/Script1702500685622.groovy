...
println("Begin Test: DCFcancelOnCFCC")
 ...
 * //softAssertion.assertEquals("$11.50", selenium.getText("//td[3]"))
 ...
 * //softAssertion.assertEquals("$13.50", selenium.getText("//td[3]/b"))
 * //softAssertion.
...
WebUI.verifyTextPresent(("Two transactions will appear on your bank statement, one in the amount of \$11.50 and one in the amount of \$2.00"), false)

selenium.click("document.process.convFeeNotifyAction[1]")
selenium.waitForPageToLoad("30000")
Thread.sleep(4000);
...
println("End Test: DCFcancelOnCFCC")
