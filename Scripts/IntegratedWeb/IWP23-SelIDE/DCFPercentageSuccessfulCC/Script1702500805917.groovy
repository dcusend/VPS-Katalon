...
println("Begin Test: DCFPercentageSuccessfulCC")
 ...
 * selenium.getText("css=td.payor_opt > p"))
 * softAssertion.assertEquals("Payment Amount:", selenium.getText("//td[2]"))
 * //softAssertion.assertEquals("$100.00", selenium.getText("//td[3]"))
 * softAssertion.assertEquals("Convenience Fees:",
...
println("End Test: DCFPercentageSuccessfulCC")
