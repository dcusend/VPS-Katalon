...
selenium.type("name=billing_firstname", "")
selenium.type("name=billing_lastname", "")
selenium.type("name=billing_address", "")
selenium.type("name=billing_address2", "")
selenium.type("name=billing_country_id", "840")
selenium.type("name=billing_city", "")
selenium.type("name=billing_state", "")
selenium.type("name=billing_zip", "")
 ...
 * softAssertion.assertEquals(Pattern.matches('selenium.getText(
 * "css=div.main_col")', "imtiazster@gmail.com.*"), true)
 * softAssertion.assertEquals(Pattern.matches('selenium.getText(
 ...
 * "Purple Label.*"), true)
 * softAssertion.assertEquals(Pattern.matches('selenium.getText("css=tbody")',
 * "Tennis Label.*"), true) //softAssertion.assertEquals("$11.50",
