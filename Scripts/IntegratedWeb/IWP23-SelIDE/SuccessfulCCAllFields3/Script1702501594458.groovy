...
println('Begin Test: SuccessfulCCAllFields3')
...
WebUI.setText(to('name=billing_firstname'), '')
WebUI.setText(to('name=billing_lastname'), '')
WebUI.setText(to('name=billing_address'), '')
WebUI.setText(to('name=billing_address2'), '')
WebUI.setText(to('name=billing_country_id'), '840')
WebUI.setText(to('name=billing_city'), '')
WebUI.setText(to('name=billing_state'), '')
WebUI.setText(to('name=billing_zip'), '')
WebUI.setText(to('name=order_number'), 'PPPPOOOO')
WebUI.setText(to('name=user_defined1'), '')
WebUI.setText(to('name=user_defined2'), '')
WebUI.setText(to('name=user_defined3'), '')
WebUI.setText(to('name=user_defined4'), '')
WebUI.setText(to('name=user_defined5'), '')
...
println('End Test: SuccessfulCCAllFields3')