...
println("Begin Test: SCFCancelOnCFPC")
...
/*
 * //softAssertion.
 * assertEquals("This transaction is subject to a Convenience Fees of $2.00.",
 * selenium.getText("css=td > p")) softAssertion.assertEquals("Payment Amount:",
 * selenium.getText("//td[2]")) //softAssertion.assertEquals("$10.50",
 * selenium.getText("//td[3]")) softAssertion.assertEquals("Convenience Fees:",
 * selenium.getText("//tr[2]/td[2]")) //softAssertion.assertEquals("$2.00",
 * selenium.getText("//tr[2]/td[3]"))
 * softAssertion.assertEquals("Total Amount:", selenium.getText("css=b"))
 * //softAssertion.assertEquals("$12.50", selenium.getText("//td[3]/b"))
 * //softAssertion.
 * assertEquals("One transaction in the amount of $12.50 will appear on your bank statement."
...
WebUI.verifyTextPresent(("One transaction in the amount of \$12.50 will appear on your bank statement"), false)



selenium.click("document.pocess.convFeeNotifyAction[1]")
selenium.waitForPageToLoad("30000")
Thread.sleep(4000);
//softAssertion.assertEquals("Payment Canceled", selenium.getText("css=h3"))

WebUI.verifyTextPresent(("Payment Canceled"), true)


println("End Test: SCFCancelOnCFPC")
