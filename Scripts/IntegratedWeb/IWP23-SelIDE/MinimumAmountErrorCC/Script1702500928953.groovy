...
println("Begin Test: MinimumAmountErrorCC")
...
selenium.waitForPageToLoad("30000")
//softAssertion.assertEquals(Pattern.matches('selenium.getText("css=div.main_col")', "Amount is less than minimum.*"), true)

WebUI.verifyTextPresent(("Amount is less than minimum"), true)

println("End Test: MinimumAmountErrorCC")
