...
println("Begin Test: AmpersandCC")
...
selenium.type("name=billingName", ("CardName & Son Mai Johnson & Son Mai Johnson & S").toString())
...
/*
 * selenium.selectWindow("null")
 * softAssertion.assertEquals("CardName & Son Mai Johnson & Son Mai Johnson & S"
...
WebUI.verifyTextPresent(("CardName & Son Mai Johnson & Son Mai Johnson & S"), true)
 ...
 * "Visa.*"), true)
 * softAssertion.assertEquals(Pattern.matches('selenium.getText("css=tbody")',
 * "CARDNAME & SON MAI JOHNSON & SON MAI JOHNSON & S.*"), true)
 * softAssertion.assertEquals(Pattern.matches('selenium.getText("css=tbody")',
 * "1111.*"), true)
 * softAssertion.assertEquals(Pattern.matches('selenium.getText("css=tbody")',
 * "AddLine1 & Son Mai Johnson & Son Mai Johnson & S.*"), true)
 * softAssertion.assertEquals(Pattern.matches('selenium.getText("css=tbody")',
 * "AddLine2 & Son Mai Johnson & Son Mai Johnson & S.*"), true)
 * softAssertion.assertEquals(Pattern.matches('selenium.getText("css=tbody")',
 * "United States.*"), true)
 * softAssertion.assertEquals(Pattern.matches('selenium.getText("css=tbody")',
 * "HOOKSETT.*"), true)
