...
println("Begin Test: MaximumAmountErrorCC")
...
selenium.waitForPageToLoad("30000")
selenium.type("name=amount", ("201.00").toString())
...
selenium.waitForPageToLoad("30000")
//softAssertion.assertEquals(Pattern.matches('selenium.getText("css=div.main_col")', "Amount is greater than maximum.*"), true)

WebUI.verifyTextPresent(("Amount is greater than maximum"), true)

println("End Test: MaximumAmountErrorCC")
