...
println('Begin Test: VerifyReceiptPageLabelsCC')
...
WebUI.verifyTextPresent('Please click here to make another payment', true)

println('End Test: VerifyReceiptPageLabelsCC')