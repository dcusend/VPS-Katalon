...
String path = fileLoc
nameSheet = "ModifyStaticTextAutopayPC"
			...
			if (WebUI.verifyTextPresent("Your payment plan has been successfully created", false) || WebUI.verifyTextPresent("AutoPay", false))
				{
					...
					WebUI.verifyElementPresent(findTestObject('Object Repository/IWP_Bootstrap/Page_EditPaymentPlan_Autopay/firstname_check'), 10)
					
					WebUI.verifyTextPresent(('Last Name on Check*'), false)
					
					WebUI.verifyElementPresent(findTestObject('Object Repository/IWP_Bootstrap/Page_EditPaymentPlan_Autopay/lastname_check'), 10)
...
//					WebUI.verifyElementPresent(findTestObject('Object Repository/IWP_Bootstrap/Page_EditPaymentPlan_Autopay/account_type_pc'), 10)
...
//					WebUI.verifyElementPresent(findTestObject('Object Repository/IWP_Bootstrap/Page_EditPaymentPlan_Autopay/startDate'), 10)
