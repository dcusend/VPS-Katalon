...
//Modify
WebUI.click(findTestObject('Object Repository/IntegratedVT/CreditDebitCard/CreditDebit_PaymentInformation/Modify'))

WebUI.setText(findTestObject('Object Repository/IntegratedVT/CreditDebitCard/input_CardNumber'), '2223520443560010')
WebUI.selectOptionByLabel(findTestObject('Object Repository/IntegratedVT/CreditDebitCard/select_MM'), '11', false)
WebUI.selectOptionByLabel(findTestObject('Object Repository/IntegratedVT/CreditDebitCard/select_YYYY'), '2028', false)
WebUI.setText(findTestObject('Object Repository/IntegratedVT/CreditDebitCard/input_CardSecurityCode'), '345')
WebUI.setText(findTestObject('Object Repository/IntegratedVT/CreditDebitCard/input_CardHolderName'), 'BBG')
...
if (
	...
	WebUI.verifyTextPresent('BBG', false) &&
	WebUI.verifyTextPresent('0010', false) &&
	WebUI.verifyTextPresent('11/2028', false)) 
