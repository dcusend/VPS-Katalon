...
switch(executionProfile)
{
	...
	case "QA2Profile":
		...
		fileLoc = 'KatalonData/IVT/VVTApiIVT_Login.xlsx'
		nameSheet = 'SubmitRequest'
		dataFile = ExcelFactory.getExcelDataWithDefaultSheet('KatalonData/IVT/VVTApiIVT_Login.xlsx', nameSheet, true)

	


// 1. Define the path to your Excel file
String filePath = "KatalonData/IVT/VVTApiIVT_Login.xlsx"

// 2. Load the workbook
//def workbook = ExcelKeywords.getWorkbook(filePath)

// 3. Get the specific sheet
//def sheet = ExcelKeywords.getExcelSheet(workbook, "SubmitRequest")

// 4. Update a cell (e.g., Row 1, Col 1 to "Passed")
//ExcelKeywords.setCellValueToCellByIndex(sheet, 0, 0, "Passed")

// 5. Save the workbook
//ExcelKeywords.saveWorkbook(filePath, workbook)
...
//reporting in excel
if (
	WebUI.verifyTextPresent('Parcel Label', false)) {
