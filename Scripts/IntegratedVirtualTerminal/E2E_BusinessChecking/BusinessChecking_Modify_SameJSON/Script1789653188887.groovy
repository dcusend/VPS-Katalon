...
//Modify
WebUI.click(findTestObject('Object Repository/IntegratedVT/BusinessChecking/BusinessChecking_PaymentInformation/Modify'))

WebUI.setText(findTestObject('Object Repository/IntegratedVT/BusinessChecking/input_AccountNumber'), '123456')
WebUI.setText(findTestObject('Object Repository/IntegratedVT/BusinessChecking/input_ConfirmAccountNumber'), '123456')
WebUI.setText(findTestObject('Object Repository/IntegratedVT/BusinessChecking/input_BusinessName'), 'XYZ Company')
WebUI.setText(findTestObject('Object Repository/IntegratedVT/BusinessChecking/input_FirstName'), 'Bharat')
WebUI.setText(findTestObject('Object Repository/IntegratedVT/BusinessChecking/input_LastName'), 'Bhushan')
...
if (
	...
	WebUI.verifyTextPresent('456', false) &&
	WebUI.verifyTextPresent('XYZ Company', false) &&
