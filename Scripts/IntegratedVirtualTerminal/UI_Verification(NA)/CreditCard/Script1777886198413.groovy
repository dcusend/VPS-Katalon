...
WebUI.verifyElementVisible(findTestObject('Object Repository/IntegratedVT/CreditDebitCard/input_AddaMessage'))
WebUI.verifyElementPresent(findTestObject('Object Repository/IntegratedVT/CreditDebitCard/input_AddaMessage'), 10)
