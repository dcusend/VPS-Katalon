...
String fileLoc = "KatalonData/IWPTestData/DisplayCFDataDemo.xlsx"
def numOfRows, dataFile, nameSheet, dataFileEmulator, Amount,AppID, feesAccept,feeType, totalAmount, isRequiredTextPresent = true


	
	
	nameSheet = "PayByPC-2.3"
	println("Number of Records: " + numOfRows)
	dataFile = ExcelFactory.getExcelDataWithDefaultSheet("KatalonData/IWPTestData/DisplayCFDataDemo.xlsx", nameSheet, true)
			...
			if (ExecuteTC.equalsIgnoreCase("Y"))
				{
					...
					if(Amount == '$5') {
						VerificationText =  "American Express, Service Fee = \$1.00, Discover, Service Fee = \$2.00, MasterCard, Service Fee = \$3.00, MasterCard Debit, Service Fee = \$6.00, Visa, Service Fee = \$5.00, Visa Debit, Service Fee = \$6.00, Personal Check, Service Fee = \$7.00, Corporate Check, Service Fee = \$8.00"						
					...
					// Select PersonalCheck Payment Method
						WebUI.click(findTestObject('Object Repository/DisplayConvFees/Page_Choose_PaymentMethod/select_btn_PC'))
					...
					// Set Data on Payment Entry page
						CustomKeywords.'iwpPages.achPersonalPaymentEntryBootstrapPage.setDataACHPPM'(row,dataFile)
