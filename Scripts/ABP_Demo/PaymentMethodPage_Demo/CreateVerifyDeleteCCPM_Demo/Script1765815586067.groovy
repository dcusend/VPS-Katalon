...
String fileLoc = "KatalonData/ABPTestDataDemo/PaymentsCC_Demo.xlsx"
String path = fileLoc
nameSheet = "CreateVerifyDeleteCCPM"
		...
		if (ExecuteTC.equalsIgnoreCase("Y"))
			{
				...
				CustomKeywords.'abpPages.PaymentsMethodPage_Demo.selectPaymentMethodCC'()
				
				//this method populates credit card data 
				CustomKeywords.'abpPages.PaymentsMethodPage_Demo.setDataCardInfo'(CardID)
