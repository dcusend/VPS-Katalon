...
//*******************Created by @Bharat Bhushan***************************************************
 ...
 String path = fileLoc
 nameSheet = "VerifyCFVerbiageOnRPCorpDCF"
		 ...
		 if (ExecuteTC.equalsIgnoreCase("Y"))
			 {
				 ...
				 CustomKeywords.'abpPages.PendingBillPage_Demo.setPersonalACHData'(ACHID)
				 ...
				 if (WebUI.verifyTextPresent("Two transactions in the amount of \$"+VTAmount+" and \$"+VTFees+" will appear on your Credit Card or Bank statement", false))
					 {
						// println("Two transactions in the amount of \$"+VTAmount +" and \$"+VTFees +" will appear on your Credit Card or Bank statement")
						 ...
						 KeywordUtil.markPassed("Verbiage is present on PaymentReciept Page")
						 resText = "Pass"
