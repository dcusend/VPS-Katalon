		 ...
		 if (ExecuteTC.equalsIgnoreCase("Y"))
			 {
				 ...
				 if (WebUI.verifyTextPresent("Available Pending Bills", false))
					 {
						 ...
						 for(def item in stringArray)
							 ...
							 if(WebUI.verifyTextPresent(item.trim(),false)) {
								...
								WebUI.verifyElementPresent(findTestObject('Object Repository/ABP/BillsLabelPage/a_PendingBills_demo'), 10)
								WebUI.verifyElementClickable(findTestObject('Object Repository/ABP/BillsLabelPage/a_PendingBills_demo'))
								WebUI.verifyElementClickable(findTestObject('Object Repository/ABP/BillsLabelPage/a_FAQ'))
								WebUI.verifyElementClickable(findTestObject('Object Repository/ABP/BillsLabelPage/a_FindOtherPendingBills_demo'))
