...
String fileLoc = "KatalonData/ABPTestDataDemo/PaymentsACH_Demo.xlsx"
 String path = fileLoc
 nameSheet = "UIVerifySelectPaymentMethodPS"
 def shortDelay = GlobalVariable.shortDelay
 dataFile = ExcelFactory.getExcelDataWithDefaultSheet(path, nameSheet, true)
 def username,password,udfID,AddressID,CardID,ACHID,nameID,firstName,lastName,addressLine1,Zip,City,State,isRequiredTextPresent = false
