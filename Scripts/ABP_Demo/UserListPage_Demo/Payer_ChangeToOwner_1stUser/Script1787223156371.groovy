...
//Part B- Change Payer to Owner
															
				String selectedUsername = CustomKeywords.'abpPages.UserListPage_1stUser.clickEditNonProfileOwnerUser'()   //to select non loggedin & Payer 'User Name'
				println("Payer to be changed = " + selectedUsername)
...
//Part C- Verifying Owner's Role after changing it from Payer to Owner
				
				WebUI.delay(2)
				CustomKeywords.'abpPages.UserListPage_1stUser.verifyUserRole'(selectedUsername, 'Profile Owner')
...
if (isRequiredTextPresent == true)
					{
						println "'Profile Owner' User Name, Role matched successfully"
					...
					{
						println "'Profile Owner' User Name, Role didn't match successfully"
