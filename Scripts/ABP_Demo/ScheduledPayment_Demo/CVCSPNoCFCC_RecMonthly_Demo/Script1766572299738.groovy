...
String fileLoc = "KatalonData/ABPTestDataDemo/SchedulePaymentABP_NoCF_Demo.xlsx"
 String path = fileLoc
 nameSheet = "CVCSPNoCFCC_RecMonthly"
		 ...
		 if (ExecuteTC.equalsIgnoreCase("Y"))
			 {
				 ...
				 CustomKeywords.'abpPages.ScheduledPaymentPage_Demo.selectPaymentMethod'(paymentMethod)
